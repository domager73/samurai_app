...
Future<void> showConfirm(
    BuildContext context, dynamic text, Function onConfirm, {String? price}) async {
              ...
              children: [
                Padding(
                  ...
                  child: Text(text.toString(),
                    ...
                    softWrap: true,
                    style: GoogleFonts.spaceMono(fontSize: width * 0.04, color: Colors.white)
                  )
                ),
                if (price != null)
                  Padding(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text('PRICE: ',
                        textAlign: TextAlign.center,
                        softWrap: true,
                        style: GoogleFonts.spaceMono(fontSize: width * 0.035, color: const Color(0xFF00FFFF), fontWeight: FontWeight.w700)
                      ),
                      Text(price!,
                        textAlign: TextAlign.center,
                        softWrap: true,
                        style: GoogleFonts.spaceMono(fontSize: width * 0.035, color: Colors.white, fontWeight: FontWeight.w700)
                      )
                    ])
                  ),
                Padding(
