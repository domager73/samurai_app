...
class CraftPageComponents {
  static Future<void> openTransferModalPage({
    ...
    Widget tabWithdraw(
      ...
      return StatefulBuilder(
        builder: (context, StateSetter setState) => Wrap(
          alignment: WrapAlignment.center,
          crossAxisAlignment: WrapCrossAlignment.center,
          children: <Widget>[
            Padding(
            ...
            PresButton(
              ...
              disabled:
                controllerWithdraw.text.isEmpty ||
        ...
        builder: (context, StateSetter setState) => Container(
          decoration: const BoxDecoration(
            ...
            image: DecorationImage(
              image: AssetImage('assets/modal_bottom_sheet_bg.png'),
              fit: BoxFit.fill
            )
          ),
          ...
          child: Padding(
            ...
            child: Wrap(
              ...
              children: <Widget>[
                Padding(
                    padding: const EdgeInsets.fromLTRB(10.0, 0.0, 10.0, 0.0), // content padding
                    child: Row(
                  ...
                  child: Column(
                    children: [
                      ...
                      PresButton(
                        ...
                        disabled: true,
                        params: {
                          'text': 'treat for 0 RYO', //TODO: Формула следующая: восстановление 0,1 XP стоит 0,4 RYO за каждого Самурая в армии. Восстановить XP можно только до 100%.
                          'width': width,
                          'height': height
                        },
                        child: loginBtn,
  ...
  static void openSwitchDialog({
    required BuildContext context,
    required double width,
    required double height,
    required Function(int) onSwitch,
    required int valSwitch
  }) {
    showDialog(
        context: context,
        builder: (BuildContext context) => StatefulBuilder(
