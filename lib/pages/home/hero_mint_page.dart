  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
      ...
      Container(
          ...
          child:
              HeroesPageTab(wigetChild: getMintMasks(context, width, height)))
    ]);
  }
            ...
            child: Row(
                ...
                children: [
                  Container(
                    ...
                    padding: e['name'].toString().toLowerCase() == 'hatamoto'
                        ? const EdgeInsets.only(bottom: 20)
                        : EdgeInsets.zero,
                    child: Image.asset(
                        'assets/hero_mask/${widget.craftSwitch == 0 ? 'water' : 'fire'}/${e['name'].toString().toLowerCase()}.PNG',
                        fit: BoxFit.contain,
                        width: width * widthCoef * 0.34),
                  ),
                  //
                  Expanded(
                    child: Container(
                              ...
                              child: Column(
                                ...
                                FittedBox(
                                  child: Text(
                                    ...
                                    maxLines: 1,
                                    style:
                                        AppTypography.spaceMonoBold20.copyWith(
                                      color: _color,
                                    ),
                                  ),
                                ),
                                ...
                                onTap: () {
                                  showDialog(
                                      ...
                                      builder: (context) => CustomChoosePopup(
                                          ...
                                          text:
                                              "Do you really want to make a hero?"));
                                },
