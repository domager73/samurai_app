...
class _SamuraiMintPageState extends State<SamuraiMintPage>
  ...
  void initState() {
    super.initState();
    samuraiWater =
        const AssetImage('assets/pages/homepage/mint/samurai_water.png');
    samuraiFire =
        const AssetImage('assets/pages/homepage/mint/samurai_fire.png');
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              child: Padding(
                ...
                child: Center(
                  child: FittedBox(
                    ...
                    'samurai mint',
                    style:
                        AppTypography.amazObitW400White.copyWith(fontSize: 40),
                    maxLines: 1,
                  )),
                ),
              ),
        ...
        Center(
            child: Container(
                ...
                child: Image(
                    image: widget.craftSwitch == 0 ? samuraiWater : samuraiFire,
                    fit: BoxFit.fitWidth))),
        Container(
            padding: EdgeInsets.only(top: width * 0.014),
            ...
            child: Stack(children: [
              Padding(
                  padding:
                      EdgeInsets.only(top: width * 0.014, left: width * 0.05),
                ...
                Padding(
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          Padding(
                              padding: EdgeInsets.only(
                                  left: width * 0.01, top: width * 0.01),
                              child: PresButton(
                                  ...
                                  onTap: () {
                                    ...
                                    showDialog(
                                        ...
                                        builder: (context) => CustomChoosePopup(
                                                ...
                                                showDialog(
                                                    ...
                                                    builder: (ctx) =>
                                                        const CustomPopup(
                                                          isError: true,
                                                          text:
                                                              'There is not enough dp in your account. Please note that dp must be in the account.',
                                                        )).then((value) =>
                                                    hideSpinner(context));
                                              });
                                            ...
                                            text:
                                                "Do you really want to mint Samurai?"));
                                  },
                                  params: {'width': width},
                                  child: mintBtn2))
                        ])),
                      ...
                      handler: FlutterSliderHandler(
                          ...
                          decoration: const BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: AssetImage(
                                      'assets/pages/homepage/mint/btn_range.png')))),
                      handlerAnimation:
                          const FlutterSliderHandlerAnimation(scale: 1.0),
