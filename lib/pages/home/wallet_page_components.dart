...
class WalletPageComponents {
  static void transferSamurai(BuildContext context,
      String mode,
      HDWallet wallet,
      String text,
      String? tokenAdress,
  ...
  static void openToGameModalPage({required BuildContext context,
    required double width,
    required double height,
    required HDWallet wallet,
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "Available: ${tokenId != null ? balance
                                          .toStringAsFixed(0) : num.parse(
                                          balance.toStringAsFixed(
                                              5))} ${tokenName.toUpperCase()}",
                                      style: GoogleFonts.spaceMono(
                                        fontSize: 13 / 844 * height,
                                        color: Colors.white,
                                      ),
  ...
  static void openTransferModalPageHero({required BuildContext context,
    required double width,
    required double height,
    required HDWallet wallet,
    required String iconPath,
