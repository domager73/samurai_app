...
class WalletPageComponents {
  ...
  static void transferSamurai(BuildContext context, String mode, HDWallet wallet,
      String text, String? tokenAdress, String token, String typeToken,
                ...
                Padding(
                  ...
                  child: PresButton(
                    ...
                    disabled:
                      ...
                      ((double.tryParse(controller.text) ?? 0.0) > (mode == 'inGame' ? balance : balanceGame)),
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  onTap: () {
                    ...
                    } else if (tokenName.toUpperCase() == 'BB' || tokenName.toLowerCase() == 'BA' ||
                        tokenName.toLowerCase() == 'GWS' || tokenName.toLowerCase() == 'GFS') {
                      WalletAPI.transfer1155Bnb(
                        wallet,
                        tokenAdress,
                        tokenId!,
                  ...
                  disabled:
                    adressController.text.isEmpty || amountController.text.isEmpty ||
                    (double.tryParse(amountController.text) ?? 0.0) <= 0 ||
                    (double.tryParse(amountController.text) ?? 0.0) > balance,
                  params: {'text': 'confirm', 'width': width, 'height': height},
                  child: loginBtn,
                )),
              ],
